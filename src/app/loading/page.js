    ...
    return (
      <main>
            ...
            <div style={{textAlign:"center", marginTop:"60px", marginBottom:"20px"}}>
                ...
                <h1 style={{fontSize:"5vw", marginTop:"14px"}}>복면가왕 | 2023.10.27 13:00</h1>
                ...
                <a className="card" style={{marginLeft:"12px", maxWidth:"95%", marginTop: "15px", backgroundColor: '#484848', color: '#FFD359', height:"70px", width:"auto"}} href='/vote'>
